...
class Lock {
	...
	Used in the case that a synchronised variable has not yet received the data required by a thread.  
	That thread will then wait until informed by a broadcast. */
	void wait();
